...
const bannerImage = 'https://source.unsplash.com/1600x900/?nature,photography,technology';
      ...
      <div className="flex flex-col pb-5">
        <div className="relative flex flex-col mb-7">
          <div className="flex flex-col justify-center items-center">
            <img src={bannerImage} alt="Banner" className="w-full h-370 2xl:h-510 shadow-lg object-cover" />
            <img src={user.image} alt="User profile" className="rounded-full w-20 h-20 -mt-10 shadow-xl object-cover" />
